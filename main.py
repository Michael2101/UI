...
class MainWindow(QWidget):
    ...
    def _create_monday_table(self):
        ...
        self.monday_table.setHorizontalHeaderLabels(['Id',"Status", "Day","Subject","Room","Time", "", ""])

        self.tuesday_table.setColumnCount(8)
        self.tuesday_table.setHorizontalHeaderLabels(['Id',"Status", "Day","Subject","Room","Time", "", ""])

        self.wednesday_table.setColumnCount(8)
        self.wednesday_table.setHorizontalHeaderLabels(['Id',"Status", "Day","Subject","Room","Time", "", ""])

        self.thursday_table.setColumnCount(8)
        self.thursday_table.setHorizontalHeaderLabels(['Id',"Status", "Day","Subject","Room","Time", "", ""])

        self.friday_table.setColumnCount(8)
        self.friday_table.setHorizontalHeaderLabels(['Id',"Status", "Day","Subject","Room","Time", "", ""])
    ...
    def _create_monday_table0(self):
        ...
        self.monday_table0.setHorizontalHeaderLabels(['Id',"Status", "Day","Subject","Room","Time", "", ""])

        self.tuesday_table0.setColumnCount(8)
        self.tuesday_table0.setHorizontalHeaderLabels(['Id',"Status", "Day","Subject","Room","Time", "", ""])

        self.wednesday_table0.setColumnCount(8)
        self.wednesday_table0.setHorizontalHeaderLabels(['Id',"Status", "Day","Subject","Room","Time", "", ""])

        self.thursday_table0.setColumnCount(8)
        self.thursday_table0.setHorizontalHeaderLabels(['Id',"Status", "Day","Subject","Room","Time", "", ""])

        self.friday_table0.setColumnCount(8)
        self.friday_table0.setHorizontalHeaderLabels(['Id',"Status", "Day","Subject","Room","Time", "", ""])
    ...
    def _update_monday_table0(self):
        ...
        self.cursor.execute(
            "SELECT * FROM timetable where day = 'Понедельник' and weekstatus = 'Нижняя' or day = ' ' order by id;")
        records = list(self.cursor.fetchall())
        ...
        self.cursor.execute("SELECT * FROM timetable where day = 'Вторник' and weekstatus = 'Нижняя'order by id;")
        records = list(self.cursor.fetchall())
        ...
        self.cursor.execute("SELECT * FROM timetable where day = 'Среда' and weekstatus = 'Нижняя' order by id;")
        records = list(self.cursor.fetchall())
        ...
        self.cursor.execute("SELECT * FROM timetable where day = 'Четверг' and weekstatus = 'Нижняя' order by id;")
        records = list(self.cursor.fetchall())
        ...
        self.cursor.execute("SELECT * FROM timetable where day = 'Пятница' and weekstatus = 'Нижняя' order by id;")
        records = list(self.cursor.fetchall())
    ...
    def _update_monday_table(self):
        ...
        self.cursor.execute(
            "SELECT * FROM timetable where day = 'Понедельник' and weekstatus = 'Верхняя' order by id;")
        records = list(self.cursor.fetchall())
        ...
        self.cursor.execute("SELECT * FROM timetable where day = 'Вторник' and weekstatus = 'Верхняя' order by id;")
        records = list(self.cursor.fetchall())
        ...
        self.cursor.execute("SELECT * FROM timetable where day = 'Среда' and weekstatus = 'Верхняя' order by id;")
        records = list(self.cursor.fetchall())
        ...
        self.cursor.execute("SELECT * FROM timetable where day = 'Четверг' and weekstatus = 'Верхняя' order by id;")
        records = list(self.cursor.fetchall())
        ...
        self.cursor.execute("SELECT * FROM timetable where day = 'Пятница' and weekstatus = 'Верхняя' order by id;")
        records = list(self.cursor.fetchall())
    ...
    def _change_day_from_table(self, rowNum):
        ...
        try:
            self.cursor.execute("update timetable set weekstatus=%s ,day=%s ,subject=%s, room_numb=%s, "
                                "start_time=%s  WHERE id=%s",(row[1],row[2],row[3],row[4],row[5],(row[0])))
        except:
            QMessageBox.about(self, "Error", "Something wrong!")
    ...
    def _change_teacher_from_table(self, rowNum):
        ...
        try:
            self.cursor.execute("update teacher Set full_name = %s "
                                ",subject = %s where id = %s", (row[1], row[2], (row[0])))
            self.conn.commit()
    ...
    def _update_shedule0(self):
        ...
        self.friday_table0.setRowCount(0)
        self.cursor.execute(
            "SELECT * FROM timetable where day = 'Понедельник' and weekstatus = 'Нижняя'  order by id;")
        records = list(self.cursor.fetchall())
    ...
    def _update_subject(self):
        ...
        self.subject_table.setItem(len(records), 0,
                                   QTableWidgetItem(' '))
        self.subject_table.setItem(len(records), 1,
                                   QTableWidgetItem(' '))
        self.subject_table.resizeRowsToContents()
    ...
    def insert_day(self):
        self.conn.rollback()
        self.cursor.execute(
                "INSERT INTO timetable (weekstatus, day, room_numb, start_time) values(' ',' ',' ', ' ');", )
        self.conn.commit()
        self._update_monday_table()
        self._update_monday_table0()
    ...
    def insert_teacher(self):
        self.conn.rollback()
        self.cursor.execute("INSERT INTO teacher (full_name)  VALUES (' ');")
        self.conn.commit()
        self._update_teacher()
